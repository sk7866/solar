...
<script lang="ts">
  ...
  const googleMapsApiKey = 'AIzaSyDF1KUigTPIJOGIoRVEV9u7M9Tyx_Wzxj0';
  const defaultPlace = {
  ...
  <aside class="flex-none md:w-96 w-80 p-2 pt-3 overflow-auto">
    <div class="flex flex-col space-y-2 h-full">
      ...
      <div class="p-4 surface-variant outline-text rounded-lg space-y-3">
        <p>
          <img alt="Logo" src="https://smartsolval.thebackendprojects.com/website/assets/media/img/logo.png">
        </p>
      </div>
      ...
      <span class="pb-4 text-center outline-text label-small">
       this is an officialy product BY mathias
      </span>
    </div>
  </aside>
</div>
